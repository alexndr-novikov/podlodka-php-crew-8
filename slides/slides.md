...
- По работе — CTO, в душе — инженер
- Рецидивист: третий доклад про Docker
- Директор программного комитета Podlodka PHP Crew
- Не внедряю ничего, пока не проверю и не подумаю 100 раз
